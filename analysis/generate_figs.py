...
df_len = pd.read_csv(filename_len)

fig = plt.figure(figsize=figsize)
df_vars["pct"].plot(kind='bar', title='Percentage of times that fixing variables lead in divergent solution')
addlabels(df_vars["pct"].index, df_vars["pct"].values)
...
addlabels(df_len["pct"].index, df_len["pct"].values)
